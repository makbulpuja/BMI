...
public class HitungActivity extends AppCompatActivity {
    ...
    public void cekHasil(View view) {
        ...
        if(edtNama.getText().toString().equals("")||
                edtBB.getText().toString().equals("")||
                edtTB.getText().toString().equals(""))
        {
            Toast.
                    makeText(getApplicationContext(),"Mohon untuk melengkapi data",Toast.LENGTH_SHORT).show();
        }
...
//Log.d("keterangan Perempuan","Over Weight/Kegemukan – anda sudah masuk kategori gemuk. sebaiknya hindari makanan berlemak dan mulailah meningkatkan olahraga seminggu minimal 2 kali");
                ...
                ket =
                        "Anda sudah masuk kategori gemuk, mulailah meningkatkan olahraga seminggu minimal 2 kali dan atur pola makan anda ";
            }
...
//Log.d("keterangan Perempuan","\tObesitas – Sebaiknya segera membuat program menurunkan berat badan karena anda termasuk kategori obesitas/ terlalu gemuk dan tidak baik bagi kesehatan");
                ...
                hasil="Obesitas";
                ket =
                        "Anda masuk dalam kategori Obesitas, segera membuat program menurunkan berat badan untuk mendapatkan badan ideal";
            }
            Log.
                    d("tag","Nama = "+nama+"\nbmi = "+bmi+"\n"+"hasil : "+hasil+"\nket : "+ket+"\n");
        }
